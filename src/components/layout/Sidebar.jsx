    ...
    <div className="w-64 bg-gradient-to-b from-gray-900 to-gray-800 text-white h-full flex flex-col shadow-xl">
      ...
      <div className="p-4 border-t border-gray-700">
        <button
          ...
          className="flex items-center space-x-3 px-4 py-3 rounded-lg text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white transition-all duration-200 w-full"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
